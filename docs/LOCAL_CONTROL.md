...
The local profile creates six entities: dehumidifier, Power switch, Temperature display, Fresh device sample, Device sample time and Last command. Temporary Home Assistant commissioning verified the retained dehumidifier entity ID and fresh local reports. Its scoped network rollback completed after confirmed OFF. The cloud entry was then restored and recovery verified through fresh cloud reports. Network rollback and restoring Home Assistant are separate steps.
